package com.cnu.library.dao.base;
...
import com.cnu.library.util.GenericsUtils;
...
public abstract class DaoSupport<T>   implements DAO<T>{
	...
	public void delete(Serializable...  entityids) {
		...
		{
			T clazz = hibernateTemplate.get(this.entityClass, id );
			if(clazz != null)
			 hibernateTemplate.delete(hibernateTemplate.get(this.entityClass, id));
		}
	}
	...
	public T find(Serializable entityId) {
		...
		return  hibernateTemplate.get(this.entityClass, entityId);
	}
	...
	public QueryResult<T> getScrollData(final int firstindex,final  int maxresult
		...
		QueryResult<T> qr = hibernateTemplate.execute(new HibernateCallback<QueryResult<T>>() {
			@Override
	...
	public List<T> getAllData(final  String wherejpql,final  Object[] queryParams,final LinkedHashMap<String,String> orderby) {
		...
		List<T> qr = hibernateTemplate.execute(new HibernateCallback<List<T>>() {
			@Override
